...
public class BrowserTest {
    ...
    public void setup() throws IOException {
        ...
        Config config = new Config(null, Browser.Type.PHANTOMJS, null, 0f, 100, 1, Config.DEFAULT_REPORT_FORMAT, false);
    ...
    public void shouldGetFirefoxDriver() throws InterruptedException {
        final Config config = new Config(null, FIREFOX, null, 5f, 800, 1, Config.DEFAULT_REPORT_FORMAT, false);
        assertSetDriverType(config, FirefoxDriver.class);
    }

    @Test
    public void shouldGetChromeDriver() throws InterruptedException {
        final Config config = new Config(null, CHROME, null, 5f, 800, 1, Config.DEFAULT_REPORT_FORMAT, false);
        assertSetDriverType(config, ChromeDriver.class);
    }

    @Test
    public void shouldGetPhantomJSDriver() throws InterruptedException {
        final Config config = new Config(null, PHANTOMJS, null, 5f, 800, 1, Config.DEFAULT_REPORT_FORMAT, false);
    ...
    public void shouldDoAllTheScreenshotWebdriverCalls() throws Exception {
        ...
        Config config = new Config(ImmutableMap.of("testurl", urlConfig), Browser.Type.FIREFOX, null, 0f, 100, 1, Config.DEFAULT_REPORT_FORMAT, false);
        testee = new Browser(parameters, config, fileService, browserUtilsMock);
